...
$available = [
    '📦 الطلبات والتحويلات' => [
        ...
        'orders_export' => 'تصدير الطلبات للطباعة والشحن',
        'fintech_transfers' => 'التحويلات والمطابقة الذكية',
        'broadcast' => 'بث إعلانات الواتساب',
        'whatsapp_bot' => 'بوت الواتساب ومسح الـ QR',
    ],
    '🛍️ المنتجات والعطور' => [
    ...
    '📂 التصنيفات وأكواد الخصم' => [
        'categories' => 'إدارة التصنيفات',
        'promo_codes' => 'أكواد الخصم والتخفيضات',
    ],
    '👥 العملاء والرسائل' => [
        'clients' => 'سجل العملاء',
        'client_statement' => 'كشف حساب العميل',
        'clients_export' => 'تصدير بيانات العملاء',
        'messages' => 'رسائل وتواصل العملاء',
        'notifications' => 'الإشعارات والتنبيهات',
    ],
    '⚙️ الإعدادات والشحن' => [
        'shipping' => 'إدارة المحافظات وأسعار الشحن',
        'settings' => 'الإعدادات العامة للمتجر',
        'admins' => 'إدارة حسابات الموظفين',
        'roles' => 'الأدوار والصلاحيات',
        'faqs' => 'الأسئلة الشائعة',
        'about_settings' => 'صفحة من نحن',
        'policy_settings' => 'سياسة الإرجاع والضمان',
    ],
    '📊 التقارير والإحصائيات' => [
        'reports' => 'التقارير المالية والمبيعات',
        'sales_records' => 'سجلات المبيعات التفصيلية',
        'product_statistics' => 'إحصائيات المنتجات الأكثر مبيعاً',
    ],
];
